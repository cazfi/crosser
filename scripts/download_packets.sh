...
GNOME_THEME_EXTRA_DIR="$(major.minor_from_version $VERSION_GNOME_THEME_EXTRA)"
...
if is_minimum_version $VERSION_SQLITE 3.22.0
then
  SQL_SUBDIR="2018/"
...
RET="$RET $?"
download_needed "$MIRROR_GNOME/sources/gnome-themes-extra/$GNOME_THEME_EXTRA_DIR/" "gnome-themes-extra" "$VERSION_GNOME_THEME_EXTRA" "tar.xz"
RET="$RET $?"
