...
if is_minimum_version $VERSION_SQLITE 3.37.2
then
  SQL_SUBDIR="2022/"
...
RET="$RET $?"
download_needed "https://github.com/libsdl-org/SDL_image/archive/refs/tags/" "SDL2_image" "release-${VERSION_SDL2_IMAGE}.tar.gz" "" "" "SDL2_image"
RET="$RET $?"
download_needed "https://github.com/libsdl-org/SDL_mixer/archive/refs/tags/" "SDL2_mixer" "release-${VERSION_SDL2_MIXER}.tar.gz" "" "" "SDL2_mixer"
RET="$RET $?"
...
download_needed "http://download.qt.io/$QT5_RELEASEDIR/qt/$QT5_DIR/$VERSION_QT5/single/" "qt5" "$VERSION_QT5" "tar.xz" \
                "http://download.qt.io/archive/qt/$QT5_DIR/$VERSION_QT5/single/"
RET="$RET $?"
download_needed "http://download.qt.io/$QT6_RELEASEDIR/qt/$QT6_DIR/$VERSION_QT6/single/" "qt6" "$VERSION_QT6" "tar.xz" \
                "http://download.qt.io/archive/qt/$QT6_DIR/$VERSION_QT6/single/"
RET="$RET $?"
