...
RET="$RET $?"
download_needed "http://www.libsdl.org/tmp/release/"    "SDL2"       "$VERSION_SDL2"       "tar.gz"
RET="$RET $?"
download_needed "http://www.libsdl.org/tmp/SDL_image/release/"      "SDL2_image" "$VERSION_SDL2_IMAGE" "tar.gz"
RET="$RET $?"
download_needed "http://www.libsdl.org/tmp/SDL_mixer/release/"      "SDL2_mixer" "$VERSION_SDL2_MIXER" "tar.gz"
RET="$RET $?"
